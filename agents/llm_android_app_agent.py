...
# Dedicated pool — Wave A is the widest: 4 static configs + N module layouts.
# 12 covers up to ~8 modules without hitting the shared default pool.
...
# ---------------------------------------------------------------------------
# Async helper — dedicated executor, no shared default pool contention
# ---------------------------------------------------------------------------

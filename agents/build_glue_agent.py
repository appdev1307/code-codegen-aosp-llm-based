...
"""
        ...
        impl_bp = """cc_binary {
    name: "android.hardware.automotive.vehicle@1.0-service",
    relative_install_path: "hw",
    init_rc: ["android.hardware.automotive.vehicle@1.0-service.rc"],
...
"""
        ...
        # init.rc
        init_rc = """service vehicle-hal-2-0 /vendor/bin/hw/android.hardware.automotive.vehicle@1.0-service
    class hal
    user system
    group system
"""
        self.writer.write(f"{self.impl_dir}/android.hardware.automotive.vehicle@1.0-service.rc", init_rc)
